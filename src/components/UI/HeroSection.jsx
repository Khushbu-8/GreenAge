...
const HeroSection = ({ title, tagline, rightImage }) => {
  return (
    <section className="relative w-full pt-28 pb-0  overflow-hidden">
      ...
      <div className="container mx-auto flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-12 lg:px-24 relative z-10">
        {/* Left Content */}
        <div className="flex-1 text-center  md:text-center max-w-lg py-5">
          <div className="text-sm md:text-base xl:text-xl font-semibold text-blue inline-block px-3 py-1 rounded-md mb-2 uppercase">
            // {tagline} //
          </div>
        ...
        {/* Right Content */}
        <div className="flex-1 relative flex justify-center items-center mb-0">
          {/* Vector-G Image (Behind about-group) */}
          <img
            src={vectorGImg}
            alt="Vector G"
            className="absolute right-0 top-0 w-full h-full object-contain opacity-16 z-[2]"
          />
